      ...
      <div class="modal-body">
        ...
        <div class="col-md-3 col-sm-6 col-xs-6">
					<div class="footer">
						...
						<p>For any quries contact us through 
                                <br>
                        foodordering@gmail.com</p>
						<form>
							<div class="form-group">
								<input class="input" placeholder="Enter Email Address">
							</div>
							<button class="primary-btn" style="background-color:#ff6600;">Join Newslatter</button>
						</form>
					</div>
				</div>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - Online Food Ordering System <a href="https://skillvertex.in/" target="_blank">Orderista</a></div></div>
        </footer>
